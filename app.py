...
def generate_recommendations(member_id, top_n=10):
    ...
    if candidate_profiles.empty:
        return None, "⚠️ No opposite-gender profiles found."
    ...
    if candidate_profiles.empty:
        return None, "⚠️ All opposite-gender profiles have been interacted with."
    ...
    if X_test.empty:
        return None, "⚠️ No valid profiles after feature engineering."
